...
{
       0,     0,     3,     4,     9,    12,    14,    15,    21,    22,
      29,    35,    37,    41,    45,    47,    51,    53,    55,    57,
      61,    63
};
...
{
      17,     0,    -1,    -1,    18,    10,    19,    11,    -1,    19,
      20,    -1,    20,    -1,    -1,    14,    21,     3,    23,     4,
      -1,    -1,    12,    22,     8,    24,     9,     4,    -1,    13,
       8,    25,     9,     4,    -1,    26,    -1,    23,    27,    26,
      -1,    24,     5,    14,    -1,    14,    -1,    25,     5,    23,
      -1,    23,    -1,    14,    -1,    15,    -1,     8,    23,     9,
      -1,     6,    -1,     7,    -1
};
...
{
       0,    49,    49,    49,    55,    56,    60,    60,    62,    62,
      63,    67,    68,    72,    73,    77,    78,    82,    85,    86,
      90,    91
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ESCRIBIR", "ID", "CONSTANTE", "$accept", "programa", "$@1",
  "sentencias", "sentencia", "$@2", "$@3", "expresion", "listaVariables",
  "parametros", "primaria", "operadorAditivo", 0
};
#endif
...
{
       0,    16,    18,    17,    19,    19,    21,    20,    22,    20,
      20,    23,    23,    24,    24,    25,    25,    26,    26,    26,
      27,    27
};
...
{
       2,     0,     0,     1,     0,     8,     0,     6,     0,     5,
       0,     0,     0,     3,     4,     0,     0,    17,    18,    16,
       0,    11,     0,    14,     0,     0,    20,    21,     0,     0,
       0,     0,     0,     0,    19,    12,    15,    10,     7,    13,
       9
};
...
{
     -17,    11,     2,   -17,   -10,   -17,    20,   -17,     4,   -17,
      21,    -7,    24,   -17,   -17,    16,    -7,   -17,   -17,    19,
       0,   -17,    -7,   -17,     5,    13,   -17,   -17,    -7,    -7,
      27,    17,    18,    29,   -17,   -17,    19,   -17,   -17,   -17,
     -17
};
...
{
      25,    16,     5,     6,     7,    29,    31,    17,    18,    30,
      32,     3,     4,    36,    33,    13,     5,     6,     7,    26,
      27,    38,    34,    26,    27,    26,    27,    22,    11,    15,
      23,    37,    39,    40,    14,    35
};
...
{
       0,    17,    18,     0,    10,    12,    13,    14,    19,    20,
      22,     8,    21,    11,    20,     8,     8,    14,    15,    23,
      25,    26,     3,    14,    24,    23,     6,     7,    27,     5,
       9,    23,     5,     9,     9,    26,    23,     4,     4,    14,
       4
};
...
/* Line 1455 of yacc.c  */
#line 60 "bisonBasico.y"
    { verificarLongId(yyleng); insertarSimbolo(yytext);}
    break;

  case 8:

/* Line 1455 of yacc.c  */
#line 62 "bisonBasico.y"
...
/* Line 1455 of yacc.c  */
#line 72 "bisonBasico.y"
    { verificarLongId(yyleng); insertarSimbolo(yytext); insertarSimboloVector(yytext); }
    break;

  case 14:

/* Line 1455 of yacc.c  */
#line 73 "bisonBasico.y"
    { verificarLongId(yyleng);insertarSimbolo(yytext); insertarSimboloVector(yytext); }
    break;
...
/* Line 1455 of yacc.c  */
#line 82 "bisonBasico.y"
    { verificarLongId(yyleng); if(buscarSimbolo(yytext)==-1){
...
/* Line 1455 of yacc.c  */
#line 85 "bisonBasico.y"
    { printf("valores %d", atoi(yytext)); }
    break;
